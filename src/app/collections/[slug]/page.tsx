      ...
      <PublicLayout>
        <div className="min-h-screen flex items-center justify-center">
          <div className="text-center">
            ...
            <p className="text-gray-600 mb-6">The collection you're looking for doesn't exist or has been moved.</p>
            <Link
              href="/collections"
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
          <nav className="flex" aria-label="Breadcrumb">
            <ol className="flex items-center space-x-4">
              ...
              <li>
                <Link href="/collections" className="text-gray-400 hover:text-gray-600 transition-colors">
                  Collections
                </Link>
              </li>
              <li>
        ...
        <section className="py-16 bg-gray-50 border-t border-gray-200">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-12">
              <h2 className="text-3xl font-bold text-gray-900 mb-4">Related Collections</h2>
              <p className="text-lg text-gray-600">
                Explore more curated collections on related topics
              </p>
            </div>
